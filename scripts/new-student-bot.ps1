...
Write-Host "  2. mvn package"
Write-Host "  3. java -jar chess-tournament/target/chess-tournament-0.1.0-SNAPSHOT-runner.jar validate-students"
Write-Host "  4. java -jar chess-tournament/target/chess-tournament-0.1.0-SNAPSHOT-runner.jar list"
Write-Host ""
